...
export function SparklesSection() {
  return (
    <div className="w-full  flex flex-col items-center justify-center overflow-hidden rounded-md">
      <h1 className="md:text-8xl text-6xl lg:text-9xl font-bold text-center relative z-20 bg-gradient-to-tr from-yellow-500 to-orange-800 bg-clip-text text-transparent">
